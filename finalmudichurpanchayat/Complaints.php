...
<body id="main_body" >
	...
	<div id="form_container">
		...
		xmlhttp.open("GET","ComplaintResponse.php?ComplaintType="+encodeURIComponent(ComplaintType),true);
		xmlhttp.send();
		}
		};
		</script>
		...
		xmlhttp.open("GET","WardResponse.php?WardNumber="+encodeURIComponent(WardNumber),true);
		xmlhttp.send();
		}
		};
		</script>
